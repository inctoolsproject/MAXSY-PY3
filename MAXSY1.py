...
wait = {
    ...
    "Respontag":"Jones dilarang tag, ntar naksir...",
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in admin:
                        ...
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"Hai Grup " + str(ginfo.name))
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                #if wait["autoBlock"] == True: md+="┃💀┃ ✔️ Autoblock「ON」\n"
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     cl.sendMessage(msg.to, "▶ เข้ากลุ่มเรียบร้อย : %s" % str(group.name))
