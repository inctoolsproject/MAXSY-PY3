...
ki = LineClient()
#ki = LineClient(authToken='ExyFpMCWEEhyj1MTxhHa.XopZAHkU3XUinBrPFnJ0YG.M4NR+Ftrm74dF3/hpwsruTbTJFbBfh9Dgidxz2Pt6Cg=')
ki.log("Auth Token : " + str(ki.authToken))
#channel1 = LineChannel(ki)
#ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient()
#kk = LineClient(authToken='Ex8txPs9n1eFDM0mTP3d.YJHt7RtSkOBrsSFO41NxBq.3tivBgRemu+gQkLniRuVDErqcXgKWlpLPqghz9aSFRs=')
kk.log("Auth Token : " + str(kk.authToken))
#channel2 = LineChannel(kk)
#kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient()
#kc = LineClient(authToken='ExvLzdNY5dvryy7vWMa6.Uz3qRQBEO7qmCi9uBt9Y5G.DvLntfuJQbnUxbjZJeEKuxD8mMPjez5pgZJK+TafDHo=')
kc.log("Auth Token : " + str(kc.authToken))
#channel3 = LineChannel(kc)
#kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kb = LineClient()
#kb = LineClient(authToken='ExziZnTjlr3nGO36Lbwf.BEngOgjyEu+11sObIEgIhW.61gO4TbyaZjgVQhOw4hgWGADfdUeO+NI/d4aMNYmerw=')
kb.log("Auth Token : " + str(kb.authToken))
#channel3 = LineChannel(kb)
#kb.log("Channel Access Token : " + str(channel3.channelAccessToken))

kd = LineClient()
#kd = LineClient(authToken='Exd1ZvlwLKIdHZPDLv73.f/xIowZCyasfzgn1I4vSqW.CgqIg87LSk9xBS+yYNnprpaaWS5FvPkuRU/KCVoUna4=')
kd.log("Auth Token : " + str(kd.authToken))
#channel3 = LineChannel(kd)
#kd.log("Channel Access Token : " + str(channel3.channelAccessToken))

ke = LineClient()
#ke = LineClient(authToken='ExyFpMCWEEhyj1MTxhHa.XopZAHkU3XUinBrPFnJ0YG.M4NR+Ftrm74dF3/hpwsruTbTJFbBfh9Dgidxz2Pt6Cg=')
ke.log("Auth Token : " + str(ke.authToken))
#channel3 = LineChannel(ke)
#ke.log("Channel Access Token : " + str(channel3.channelAccessToken))

kf = LineClient()
#kf = LineClient(authToken='Ex8txPs9n1eFDM0mTP3d.YJHt7RtSkOBrsSFO41NxBq.3tivBgRemu+gQkLniRuVDErqcXgKWlpLPqghz9aSFRs=')
kf.log("Auth Token : " + str(kf.authToken))
#channel3 = LineChannel(kf)
#kf.log("Channel Access Token : " + str(channel3.channelAccessToken))

kg = LineClient()
#kg = LineClient(authToken='ExvLzdNY5dvryy7vWMa6.Uz3qRQBEO7qmCi9uBt9Y5G.DvLntfuJQbnUxbjZJeEKuxD8mMPjez5pgZJK+TafDHo=')
kg.log("Auth Token : " + str(kg.authToken))
#channel3 = LineChannel(kg)
#kg.log("Channel Access Token : " + str(channel3.channelAccessToken))

kh = LineClient()
#kh = LineClient(authToken='ExziZnTjlr3nGO36Lbwf.BEngOgjyEu+11sObIEgIhW.61gO4TbyaZjgVQhOw4hgWGADfdUeO+NI/d4aMNYmerw=')
kh.log("Auth Token : " + str(kh.authToken))
#channel3 = LineChannel(kh)
#kh.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient()
#sw = LineClient(authToken='Exd1ZvlwLKIdHZPDLv73.f/xIowZCyasfzgn1I4vSqW.CgqIg87LSk9xBS+yYNnprpaaWS5FvPkuRU/KCVoUna4=')
...
owner = ["ub8fd0c502d6d52c35d8bc6fcced407d0","uc71f1ca3dadb081dd7f57a1a947b66b5"]
admin = ["ub8fd0c502d6d52c35d8bc6fcced407d0","uc71f1ca3dadb081dd7f57a1a947b66b5"]
staff = ["ub8fd0c502d6d52c35d8bc6fcced407d0","uc71f1ca3dadb081dd7f57a1a947b66b5"]
                           ...
                           # if msg._from in admin:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     kd.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     ...
                                     kg.acceptGroupInvitationByTicket(group2.id,ticket_id)
